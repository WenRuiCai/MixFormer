...
def main():
    args = parse_args()
    if args.mode == "single":
        train_cmd = "/home/wenrui/anaconda3/envs/mixformer/bin/python lib/train/run_training.py --script %s --config %s --save_dir %s --use_lmdb %d " \
        ...
        train_cmd = "/home/wenrui/anaconda3/envs/mixformer/bin/python -m torch.distributed.launch --master_port %d --nproc_per_node %d lib/train/run_training.py " \
